              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={serie} onValueChange={(val) => setSerie(val)}>
                    ...
                    <SelectContent>
                      <SelectItem value="Infantil II">Infantil II da Educação Infantil</SelectItem>
                      <SelectItem value="Infantil III">Infantil III da Educação Infantil</SelectItem>
                      <SelectItem value="Infantil IV">Infantil IV da Educação Infantil</SelectItem>
                      <SelectItem value="Infantil V">Infantil V da Educação Infantil</SelectItem>
                      <SelectItem value="1° ano">1° ano do Ensino Fundamental I</SelectItem>
                      <SelectItem value="2° ano">2° ano do Ensino Fundamental I</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
